...
public class InsuranceQuote {
    ...
    /** Call before saving to set generated fields. */
    ...
    public String getStatusIndex() { return statusIndex; }
    public void setStatusIndex(String statusIndex) { this.statusIndex = statusIndex; }

    @DynamoDbAttribute("productOfferIndex")
    public String getProductOfferIndex() { return productOfferIndex; }
    public void setProductOfferIndex(String productOfferIndex) { this.productOfferIndex = productOfferIndex; }
}
