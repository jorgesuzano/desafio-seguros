...
/**
 * Inbound adapter: polls SQS for InsurancePolicyCreated events and delegates
 * to PolicyUpdateUseCase. ISP: depends only on the narrow use-case port it needs.
 */
@Slf4j
@Component
@EnableScheduling
...
public class PolicyEventListener {
    ...
    private void processMessage(Message message, String queueUrl) {
        try {
            ...
            policyUpdateUseCase.updateQuoteWithPolicyId(
                    event.getQuoteId(),
